...
export default function CodeEditor() {
  ...
  return (
    ...
    <WindowFrame
      title="Code Editor Simulation - hello.js"
      onClose={closeCodeEditor}
      iconPath="/images/code.png"
    >
      {/* Main flex container for editor layout */}
      <div className="flex flex-col h-full text-sm bg-[#1e1e1e]">
        {" "}
        {/* Editor background */}
        ...
        <div className="overflow-auto font-mono text-xs flex-grow h-[65%]">
          {" "}
        ...
        <div className="flex flex-col flex-shrink-0 border-t-2 border-gray-700 h-[35%]">
          {" "}
          {/* Adjust height % */}
          {/* Terminal Header */}
